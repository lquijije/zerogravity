<?php /* Smarty version Smarty-3.1.19, created on 2018-04-20 10:03:56
         compiled from "/var/www/html/modules/angarmenu/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8460775015ada015c2b4294-01224741%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44f5871772cbf7fbadb1c5c603eea407ea79be12' => 
    array (
      0 => '/var/www/html/modules/angarmenu/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1523900221,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8460775015ada015c2b4294-01224741',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ada015d0faf62_59073624',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ada015d0faf62_59073624')) {function content_5ada015d0faf62_59073624($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/tools/smarty/plugins/function.counter.php';
?>
...
<?php } else { ?>9<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?> col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='link_choice') {?>
	    <div class="row">
	    	<div class="col-lg-1">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Change position','mod'=>'angarmenu'),$_smarty_tpl);?>
</h4> 
	    	...
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Selected items','mod'=>'angarmenu'),$_smarty_tpl);?>
</h4>
	    		<?php echo $_smarty_tpl->tpl_vars['selected_links']->value;?>
 
	    	</div>
	    	<div class="col-lg-4">
	    		<h4 style="margin-top:5px;"><?php echo smartyTranslate(array('s'=>'Available items','mod'=>'angarmenu'),$_smarty_tpl);?>
</h4>
	    ...
	    <div class="row">
	    	...
	    	<div class="col-lg-4"><a href="#" id="removeItem" class="btn btn-default"><i class="icon-arrow-right"></i> <?php echo smartyTranslate(array('s'=>'Remove','mod'=>'angarmenu'),$_smarty_tpl);?>
</a></div>
	    	<div class="col-lg-4"><a href="#" id="addItem" class="btn btn-default"><i class="icon-arrow-left"></i> <?php echo smartyTranslate(array('s'=>'Add','mod'=>'angarmenu'),$_smarty_tpl);?>
</a></div>
	    </div>
	<?php } else { ?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '8460775015ada015c2b4294-01224741');
content_5ada015ccffb44_62779487($_smarty_tpl);
...
function add()
{
	$("#availableItems option:selected").each(function(i){
		...
		if (val == "PRODUCT")
		{
			val = prompt('<?php echo smartyTranslate(array('s'=>'Indicate the ID number for the product','mod'=>'angarmenu','js'=>1),$_smarty_tpl);?>
');
			if (val == null || val == "" || isNaN(val))
				return;
			text = '<?php echo smartyTranslate(array('s'=>'Product ID #','mod'=>'angarmenu','js'=>1),$_smarty_tpl);?>
'+val;
			val = "PRD"+val;
		}
...
function move(up)
{
        ...
        if (tomove.length >1)
        {
                alert('<?php echo smartyTranslate(array('s'=>'Please select just one item','mod'=>'angarmenu'),$_smarty_tpl);?>
');
                return false;
        }
        if (up)
...
<?php if ($_valid && !is_callable('content_5ada015ccffb44_62779487')) {function content_5ada015ccffb44_62779487($_smarty_tpl) {?>
