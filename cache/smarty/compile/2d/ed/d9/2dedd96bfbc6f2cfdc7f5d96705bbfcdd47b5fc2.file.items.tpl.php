<?php /* Smarty version Smarty-3.1.19, created on 2018-04-20 10:15:33
         compiled from "/var/www/html/modules/angarbanners/views/templates/admin/items.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11426526885ada041564bef6-25777920%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2dedd96bfbc6f2cfdc7f5d96705bbfcdd47b5fc2' => 
    array (
      0 => '/var/www/html/modules/angarbanners/views/templates/admin/items.tpl',
      1 => 1523900221,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11426526885ada041564bef6-25777920',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ada04157524e9_17723851',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ada04157524e9_17723851')) {function content_5ada04157524e9_17723851($_smarty_tpl) {?>

<script>
 	theme_url='<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['htmlitems']->value['theme_url'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
'
</script>
...
?>
		<h4 class="hook-title"><?php echo smartyTranslate(array('s'=>'Hook','mod'=>'angarbanners'),$_smarty_tpl);?>
...
" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
							<div class="btn-group pull-right">
								<button class="btn btn-default button-edit">
									<span class="button-edit-edit"><i class="icon-edit"></i> <?php echo smartyTranslate(array('s'=>'Edit','mod'=>'angarbanners'),$_smarty_tpl);?>
</span>
									<span class="button-edit-close hide"><i class="icon-remove"></i> <?php echo smartyTranslate(array('s'=>'Close','mod'=>'angarbanners'),$_smarty_tpl);?>
</span>
								</button>
...
" name="removeItem" class="link-item-delete">
											<i class="icon-trash"></i> <?php echo smartyTranslate(array('s'=>'Delete item','mod'=>'angarbanners'),$_smarty_tpl);?>
...
views/img/<?php echo $_smarty_tpl->tpl_vars['hItem']->value['image'];?>
...
" />
									...
									<div class="col-lg-9 col-lg-offset-3">
										<div class="checkbox">
											<label class="control-label">
												<?php echo smartyTranslate(array('s'=>'Enable','mod'=>'angarbanners'),$_smarty_tpl);?>
								...
								<div class="title item-field form-group">
									<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Image title','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
									<div class="col-lg-7">
...
" />
								...
								<div class="title_use item-field form-group">
									<div class="col-lg-9 col-lg-offset-3">
										<div class="checkbox">
											<label class="control-label">
												<?php echo smartyTranslate(array('s'=>'Use title in front','mod'=>'angarbanners'),$_smarty_tpl);?>
								...
								<div class="hook item-field form-group">
									<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Hook to which the image should be attached','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
									<div class="col-lg-7">
										<select name="item_hook" default="top" class="fixed-width-lg">
											...
											<option value="bottom"<?php if ($_smarty_tpl->tpl_vars['hItem']->value['hook']=='bottom') {?> selected="selected"<?php }?>>bottom</option>
								...
								<div class="image item-field form-group">
									<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Load your image','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
									<div class="col-lg-7">
								...
								<div class="image_w item-field form-group">
									<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Image width','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
									<div class="col-lg-7">
...
"/>
											<span class="input-group-addon"><?php echo smartyTranslate(array('s'=>'pixels','mod'=>'angarbanners'),$_smarty_tpl);?>
</span>
										</div>
									</div>
								</div>
								<div class="image_h item-field form-group">
									<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Image height','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
									<div class="col-lg-7">
										<div class="input-group fixed-width-lg">
...
"/>
								...
								<div class="url item-field form-group">
									<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Target link','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
									<div class="col-lg-7">
...
" />
								...
								<div class="target item-field form-group">
									<div class="col-lg-9 col-lg-offset-3">
										<div class="checkbox">
											<label class="control-label">
												<?php echo smartyTranslate(array('s'=>'Open link in a new tab/page','mod'=>'angarbanners'),$_smarty_tpl);?>
								...
								<div class="html item-field form-group">
									<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Optional HTML code','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
									<div class="col-lg-7">
								...
								<div class="form-group">
									<div class="col-lg-7 col-lg-offset-3">
										<button type="button" class="btn btn-default button-item-edit-cancel" >
											<i class="icon-remove"></i> <?php echo smartyTranslate(array('s'=>'Cancel','mod'=>'angarbanners'),$_smarty_tpl);?>

										</button>
										<button type="submit" name="updateItem" class="btn btn-success button-save pull-right" >
											<i class="icon-save"></i> <?php echo smartyTranslate(array('s'=>'Save','mod'=>'angarbanners'),$_smarty_tpl);?>
		...
		<?php } else { ?>
			<div class="item">
				<span class="text-muted"><?php echo smartyTranslate(array('s'=>'No items available','mod'=>'angarbanners'),$_smarty_tpl);?>
</span>
			</div>
		<?php }?>
	<?php } ?>
