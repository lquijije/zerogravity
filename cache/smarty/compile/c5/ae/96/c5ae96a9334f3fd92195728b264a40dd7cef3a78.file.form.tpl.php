<?php /* Smarty version Smarty-3.1.19, created on 2018-04-20 10:30:34
         compiled from "/var/www/html/modules/angarparallax/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2040265945ada079a6f1054-43441709%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c5ae96a9334f3fd92195728b264a40dd7cef3a78' => 
    array (
      0 => '/var/www/html/modules/angarparallax/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1523900221,
      2 => 'file',
    ),
    '09c47c8f9cf6e45c464241eacd07f75242ba0ff6' => 
    array (
      0 => '/var/www/html/admin93185fjw6/themes/default/template/helpers/form/form.tpl',
      1 => 1523541099,
      2 => 'file',
    ),
    '1ff073874f9e371751ff97eaa5ea24b6ca02ae51' => 
    array (
      0 => '/var/www/html/admin93185fjw6/themes/default/template/helpers/form/form_group.tpl',
      1 => 1523541099,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2040265945ada079a6f1054-43441709',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ada079b5ee9a9_02619106',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ada079b5ee9a9_02619106')) {function content_5ada079b5ee9a9_02619106($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/tools/smarty/plugins/function.counter.php';
?>
...
-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
									<i class="icon-folder-open"></i> <?php echo smartyTranslate(array('s'=>'Choose a file','mod'=>'angarparallax'),$_smarty_tpl);?>
...
?>
				...
				<div class="form-group">
					...
					<div id="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
-<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
-images-thumbnails" class="col-lg-12">
						<img src="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['uri']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
views/img/<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" class="img-thumbnail"/>
					</div>
					<?php }?>
				</div>
...
-name').val(file[file.length-1]);
			...
			<?php if (isset($_smarty_tpl->tpl_vars['input']->value['desc'])&&!empty($_smarty_tpl->tpl_vars['input']->value['desc'])) {?>
				<p class="help-block">
					<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['desc'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '2040265945ada079a6f1054-43441709');
content_5ada079b212684_32600197($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2018-04-20 10:30:35
         compiled from "/var/www/html/admin93185fjw6/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5ada079b212684_32600197')) {function content_5ada079b212684_32600197($_smarty_tpl) {?>
