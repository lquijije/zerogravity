<?php /* Smarty version Smarty-3.1.19, created on 2018-04-20 10:15:33
         compiled from "/var/www/html/modules/angarbanners/views/templates/admin/new.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7477001845ada04155e3387-03337519%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d25a997cb163392cd3d31542ecffdb0c973063a' => 
    array (
      0 => '/var/www/html/modules/angarbanners/views/templates/admin/new.tpl',
      1 => 1523900221,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7477001845ada04155e3387-03337519',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ada0415645490_30085629',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ada0415645490_30085629')) {function content_5ada0415645490_30085629($_smarty_tpl) {?>

<div class="new-item">
	<div class="form-group">
		<button type="button" class="btn btn-default btn-lg button-new-item"><i class="icon-plus-sign"></i> <?php echo smartyTranslate(array('s'=>'Add item','mod'=>'angarbanners'),$_smarty_tpl);?>
</button>
	</div>
...
" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
			<div class="well">
				<div class="language item-field form-group">
					<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Language','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
					<div class="col-lg-7">
...
" />
				...
				<div class="hook item-field form-group">
					<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Hook','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
					<div class="col-lg-7">
				...
				<div class="image item-field form-group">
					<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Image','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
					<div class="col-lg-7">
				...
				<div class="image_w item-field form-group">
					...
					<div class="col-lg-7">
						<div class="input-group fixed-width-lg">
							<span class="input-group-addon"><?php echo smartyTranslate(array('s'=>'px','mod'=>'angarbanners'),$_smarty_tpl);?>
</span>
				...
				<div class="url item-field form-group">
					<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'URL','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
					<div class="col-lg-7">
				...
				<div class="target item-field form-group">
					<div class="col-lg-9 col-lg-offset-3">
						<div class="checkbox">
							<label class="control-label">
								<?php echo smartyTranslate(array('s'=>'Target blank','mod'=>'angarbanners'),$_smarty_tpl);?>
				...
				<div class="html item-field form-group">
					<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'HTML','mod'=>'angarbanners'),$_smarty_tpl);?>
</label>
					<div class="col-lg-7">
				...
				<div class="form-group">
					<div class="col-lg-7 col-lg-offset-3">
						<button type="button" class="btn btn-default button-new-item-cancel"><i class="icon-remove"></i> <?php echo smartyTranslate(array('s'=>'Cancel','mod'=>'angarbanners'),$_smarty_tpl);?>
</button>
						<button type="submit" name="newItem" class="btn btn-success button-save pull-right"><i class="icon-save"></i> <?php echo smartyTranslate(array('s'=>'Save','mod'=>'angarbanners'),$_smarty_tpl);?>
</button>
					</div>
				</div>
			</div>
