<?php /* Smarty version Smarty-3.1.19, created on 2018-07-09 14:10:57
         compiled from "C:\xampp\htdocs\zerogravity\themes\AngarTheme\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:48875b43b34173b4e1-53807832%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '542719eacac99ee8084ddb93427703757ffd08e2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\zerogravity\\themes\\AngarTheme\\modules\\blockcart\\blockcart.tpl',
      1 => 1523900221,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '48875b43b34173b4e1-53807832',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b43b341a597a0_97891593',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b43b341a597a0_97891593')) {function content_5b43b341a597a0_97891593($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\zerogravity\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'C:\\xampp\\htdocs\\zerogravity\\tools\\smarty\\plugins\\function.counter.php';
?>
<!-- MODULE Block cart -->
<?php if (isset($_smarty_tpl->tpl_vars['blockcart_top']->value)&&$_smarty_tpl->tpl_vars['blockcart_top']->value) {?>

<div class="cart_container col-sm-4 clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
...
" rel="nofollow">
			...
			<span class="ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'Products','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
...
<a class="account_cart_rwd" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Your account','mod'=>'blockcart'),$_smarty_tpl);?>
" rel="nofollow"><span><?php echo smartyTranslate(array('s'=>'Your account','mod'=>'blockcart'),$_smarty_tpl);?>
</span></a>
