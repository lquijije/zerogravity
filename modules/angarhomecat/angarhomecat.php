...
class AngarHomeCat extends Module
{
    ...
    public function hookAngarHomeCat($params)
    {
        ...
        if (!$this->isCached('views/templates/front/at_homecat.tpl', $this->getCacheId())) {
        ...
        return $this->display(__FILE__, 'views/templates/front/at_homecat.tpl', $this->getCacheId());
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitModule')) {
            ...
            $this->_clearCache('views/templates/front/at_homecat.tpl');
    ...
    public function renderForm()
    {
        ...
        $fields_form = array(
            'form' => array(
                ...
                'description' => $this->l('This module displays featured categories on the home page.'),
                'input' => array(
