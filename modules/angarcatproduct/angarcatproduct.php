...
class AngarCatproduct extends Module
{
    ...
    public function install()
    {
        return parent::install()
            && Configuration::updateValue('AT_CATPRODUCT_ID', implode(',', array(3,4,8,11)))
    ...
    public function hookAngarProductCat($params)
    {
        ...
        foreach ($catArray as $id_category) {
            ...
            $arrayCatProduct[] = array('id' => $id_category, 'name'=> $category->name, 'product' => $categoryProducts);
        }

        if (!$this->isCached('views/templates/front/at_catproduct.tpl', $this->getCacheId())) {
        ...
        return $this->display(__FILE__, 'views/templates/front/at_catproduct.tpl', $this->getCacheId());
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitModule')) {
            ...
            $this->_clearCache('views/templates/front/at_catproduct.tpl');
