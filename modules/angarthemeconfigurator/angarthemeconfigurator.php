...
class Angarthemeconfigurator extends Module
{
    ...
    public function install()
    {
        return parent::install()
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_CSS24', 'home_tabs2')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR1', '#f6f6f6')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR4', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR5', '#1bbc9b')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR6', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR7', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR8', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR9', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR59', '#ff5722')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR10', '#1bbc9b')
            ...
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR15', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR16', '#1bbc9b')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR17', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR18', '#ff5722')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR19', '#1bbc9b')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR20', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR21', '#282828')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR22', '#ff5722')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR23', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR24', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR25', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR26', '#1b1a1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR27', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR28', '#1b1a1b')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR29', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR30', '#f6f6f6')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR31', '#dddddd')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR32', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR33', '#000000')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR34', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR35', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR36', '#f6f6f6')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR37', '#dddddd')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR38', '#000000')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR39', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR40', '#1b1a1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR41', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR42', '#1b1a1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR43', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR44', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR45', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR46', '#1bbc9b')

            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR47', '#43b754')
            ...
            // Featured categories
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR60', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR61', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR62', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR63', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR64', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR65', '#1b1a1b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR66', '#ffffff')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR67', '#1b1a1b')

            // Products from category
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR68', '#1bbc9b')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR69', '#ff5722')
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR70', '#1bbc9b')

            // Featured manufacturers
            && Configuration::updateValue('ANGARTHEMECONFIGURATOR_COLOR71', '#1bbc9b')
