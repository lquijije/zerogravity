...
class Angarcmsdesc extends Module
{
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('saveangarcmsdesc')) {
            ...
            $info3->delete();
            $this->_clearCache('views/templates/front/angarcmsdesc.tpl');
    ...
    {
        if (!$this->isCached('views/templates/front/angarcmsdesc.tpl', $this->getCacheId())) {
        ...
        return $this->display(__FILE__, 'views/templates/front/angarcmsdesc.tpl', $this->getCacheId());
    }
