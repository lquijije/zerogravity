...
class Angarcmsinfo extends Module
{
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('saveangarcmsinfo')) {
            ...
            $info2->delete();
            $this->_clearCache('views/templates/front/angarcmsinfo.tpl');
    ...
    {
        if (!$this->isCached('views/templates/front/angarcmsinfo.tpl', $this->getCacheId())) {
        ...
        return $this->display(__FILE__, 'views/templates/front/angarcmsinfo.tpl', $this->getCacheId());
    }
    ...
    public function installFixtures()
    {
        ...
        array(
        'text' => '
	    <p class="icon-truck icon_cms"><span>icon</span></p>
	    <h3>Free shipping</h3>
        ...
        array(
        'text' => '
        <p class="icon-refresh icon_cms"><span>icon</span></p>
        ...
        array(
        'text' => '
        <p class="icon-comments-o icon_cms"><span>icon</span></p>
        <h3>Support 24/7</h3>
        ...
        array(
        'text' => '
        <p class="icon-lock icon_cms"><span>icon</span></p>
        <h3>Safe Payment</h3>
