...
class AngarFacebook extends Module
{
    ...
    public function install()
    {
        return parent::install() &&
            Configuration::updateValue('angarfacebook_url', 'https://www.facebook.com/prestashop') &&
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitModule')) {
            ...
            $this->_clearCache('views/templates/front/angarfacebook.tpl');
    ...
    {
        if (!$this->isCached('views/templates/front/angarfacebook.tpl', $this->getCacheId())) {
            $facebookurl = Configuration::get('angarfacebook_url');
            if (!strstr($facebookurl, 'facebook.com')) {
                $facebookurl = 'https://www.facebook.com/'.$facebookurl;
            }
        ...
        return $this->display(__FILE__, 'views/templates/front/angarfacebook.tpl', $this->getCacheId());
    }
