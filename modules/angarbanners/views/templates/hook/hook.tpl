...
{if $hook == 'left' || $hook == 'right'}
	...
	<li class="block">
		<h4 class="title_block {if $hItem.title_use == 1}banner_title{/if}"><span>{if $hItem.title}{$hItem.title|escape:'htmlall':'UTF-8'}{else}{l s='Banner' mod='angarbanners'}{/if}</span></h4>
		...
		<div class="block_content">
			...
			{/if}
				...
				{if $hItem.html}
					<div class="itemhtml_desc">{$hItem.html|escape:'htmlall':'UTF-8'}</div>
				{/if}
