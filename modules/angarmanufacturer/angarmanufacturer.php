...
class AngarManufacturer extends Module
{
    ...
    public function hookAngarManufacturer($params)
    {
        ...
        foreach ($manuArray as $id_manufacturer) {
            ...
            $imageurl = $this->context->language->iso_code.'-'.ImageType::getFormatedName('default-medium').'.jpg';
            if (file_exists(_PS_MANU_IMG_DIR_.$id_manufacturer.'-'.ImageType::getFormatedName('medium').'.jpg')) {
                $imageurl = $id_manufacturer.'-'.ImageType::getFormatedName('medium').'.jpg';
            }

            $arrayMan[] = array('id' => $id_manufacturer, 'name' => $manufacturer->name, 'link_rewrite' => $manufacturer->link_rewrite, 'image' => $imageurl);
        }

        if (!$this->isCached('views/templates/front/at_manufacturer.tpl', $this->getCacheId())) {
        ...
        return $this->display(__FILE__, 'views/templates/front/at_manufacturer.tpl', $this->getCacheId());
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitModule')) {
            ...
            $this->_clearCache('views/templates/front/at_manufacturer.tpl');
