...
class AngarParallax extends Module
{
    ...
    protected function installFixture($id_lang, $image = null)
    {
        ...
        $values['AT_PARALLAX_DESC'][(int)$id_lang] = '<h1>Parallax banner</h1><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ac posuere quam. Proin consectetur, ligula nec pellentesque viverra, nisi nulla pellentesque est, ut iaculis orci turpis ut nibh.</p>';
    ...
    {
        if (!$this->isCached('views/templates/front/at_parallax.tpl', $this->getCacheId())) {
        ...
        return $this->display(__FILE__, 'views/templates/front/at_parallax.tpl', $this->getCacheId());
    }
    ...
    public function postProcess()
    {
        if (Tools::isSubmit('submitStoreConf')) {
            ...
            $this->_clearCache('views/templates/front/at_parallax.tpl');
