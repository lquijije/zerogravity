...
{l s='My account'}
<a href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Log me out'}">({l s='Sign out'})</a>
</h1>
...
<div class="row addresses-lists">
	<div class="col-xs-12 col-sm-6 {if $hide_left_column && $hide_right_column}col-lg-4{/if}">
