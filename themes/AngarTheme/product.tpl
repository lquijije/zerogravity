		...
		*}
		...
		<div class="pb-left-column col-xs-12 col-sm-4 col-md-5">
			...
			<div id="image-block" class="clearfix">
				...
				{* AngarTheme *}
				{if $product->on_sale}
					<span class="sale-box no-print {if $product->new}sale-box_new{/if}">
...
{* AngarTheme discount position *}
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
			<!-- quantity discount -->
			<section class="page-product-box">
				{* <h3 class="page-product-heading"><span>{l s='Volume discounts'}</span></h3> *}
		...
		{/if}
{* AngarTheme discount position end *}
			...
			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
				...
				<div class="box-info-product">
					...
					<div class="box-cart-bottom">
						...
						<div class="add_to_cart_box {if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE}unvisible{/if}">
...
{* AngarTheme tabs *}
		...
		<section id="blockpack2">
			<h3 class="page-product-heading"><span>{l s='Pack content'}</span></h3>
    ...
    <div id="more_info_sheets">
		...
		{if isset($features) && $features}
			...
			<section id="idTab2" class="page-product-box">
				<h3 class="page-product-heading"><span>{l s='Data sheet'}</span></h3>
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			...
			<section id="idTab3" class="page-product-box">	
				<h3 class="page-product-heading"><span>{l s='Download'}</span></h3>
			...
			<section id="idTab15" class="page-product-box">
				<h3 class="page-product-heading"><span>{l s='Product customization'}</span></h3>
...
{* AngarTheme end of tab box *}
		...
		{if isset($accessories) && $accessories}
			...
			<section class="page-product-box accessories">
				<h3 class="page-product-heading"><span>{l s='Accessories'}</span>
							...
							<li class="col-xs-12 col-sm-4 col-md-4">
								...
								<div class="product-image-container">
									<a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" class="product-image product_image">
										<img class="replace-2x img-responsive" src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'home_default')|escape:'html':'UTF-8'}" alt="{$accessory.legend|escape:'html':'UTF-8'}" width="{$homeSize.width}" height="{$homeSize.height}"/>
									</a>

									{if isset($accessory.new) && $accessory.new == 1}
										<a class="new-box" href="{$accessoryLink|escape:'html':'UTF-8'}">
											<span class="new-label">{l s='New'}</span>
										</a>
									{/if}
									...
									{if isset($accessory.on_sale) && $accessory.on_sale && isset($accessory.show_price) && $accessory.show_price && !$PS_CATALOG_MODE}
										<a class="sale-box {if isset($accessory.new) && $accessory.new == 1}sale-box_new{/if}" href="{$accessoryLink|escape:'html':'UTF-8'}">
											<span class="sale-label">{l s='Sale!'}</span>
										</a>
									{/if}
								...
								<div class="right-block">
									<h5 itemprop="name">
										<a class="product-name" href="{$accessoryLink|escape:'html':'UTF-8'}">
											{$accessory.name|truncate:80:'...':true|escape:'html':'UTF-8'}
										</a>
									</h5>
								...
								<div class="button-container">
									...
									{/if}
									<a class="button lnk_view btn btn-default" href="{$accessoryLink|escape:'html':'UTF-8'}" title="{l s='More'}">
										<span>{l s='More'}</span>
									</a>
								</div>
