		...
		<fieldset>
			<div class="box">
				...
				<div id="opc_account_form" class="unvisible">
					...
					{* AngarTheme *}
					<div class="col-xs-12 col-md-6 account_column_left">
					<h3 class="page-subheading top-indent">{l s='Your personal information'}</h3>
					...
					{* AngarTheme *}
					<div class="required clearfix gender-line gender">
					...
					{* AngarTheme *}
					<div class="select form-group date-select birthday">
					...
					{* AngarTheme *}
					<div class="col-xs-12 col-md-6 account_column_right">
