...
<div id="stores_block_left" class="block">
	<p class="title_block">
		<a href="{$link->getPageLink('stores')|escape:'html':'UTF-8'}" title="{l s='Our store(s)!' mod='blockstore'}">
	...
	<div class="block_content blockstore">
		...
		<div>
			...
			title="{l s='Our stores' mod='blockstore'}">
				<span>{l s='Discover our store(s)!' mod='blockstore'}<i class="icon-chevron-right right"></i></span>
			</a>
		</div>
	</div>
</div>
