...
{* AngarTheme *}
<div class="cart_container col-sm-4 clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart"> {* AngarTheme start *}
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">{l s='Products' mod='blockcart'}</span>
...
<a class="account_cart_rwd" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Your account' mod='blockcart'}" rel="nofollow"><span>{l s='Your account' mod='blockcart'}</span></a>

{*
<div class="cart_account">

{if $is_logged}		
	<a class="cart_customer_name" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='View my customer account' mod='blockcart'}" rel="nofollow"><span>{$cookie->customer_firstname} {$cookie->customer_lastname}</span></a>
	<a href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Log me out' mod='blockcart'}">{l s='(Sign out)' mod='blockcart'}</a>
{else}
	<a class="account_icon cart_login" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Login or register' mod='blockcart'}">{l s='Login or register' mod='blockcart'}</a>
{/if}

<a class="account_icon cart_your_account {if isset($is_logged) && $is_logged}cart_your_account_logged{/if}" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Your account' mod='blockcart'}" rel="nofollow">{l s='Your account' mod='blockcart'}</a>
