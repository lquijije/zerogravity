...
<section class="footer-block col-xs-12 col-sm-3">
	<h4><a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Manage my customer account' mod='blockmyaccountfooter'}" rel="nofollow"><span>{l s='My account' mod='blockmyaccountfooter'}</span></a></h4>
