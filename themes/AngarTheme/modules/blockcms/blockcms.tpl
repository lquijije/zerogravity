...
{else}
	...
	<section class="footer-block col-xs-12 col-sm-3" id="block_various_links_footer">
		<h4><span>{l s='Our offer' mod='blockcms'}</span></h4>
	...
	<section class="bottom-footer col-xs-12">
		<div>
			{if $footer_text}{$footer_text}{else}&copy; {l s='Copyright' mod='blockcms'} {'Y'|date} {$shop_name|escape:'html':'UTF-8'}.  {l s='All Rights Reserved.' mod='blockcms'} {/if}
		</div>
	</section>
	{/if}
