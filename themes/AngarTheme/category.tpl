			...
			<div class="content_scene_cat_layout2">
				...
				{else}
					...
					<div class="category-image col-xs-12 col-sm-2">
						<img class="img-responsive" src="{$link->getCatImageLink($category->link_rewrite, $category->id_image, 'category_default')|escape:'html':'UTF-8'}" alt="" width="{$categorySize.width}" height="{$categorySize.height}" />
					</div>
					{/if}

					{if $category->description}
                            <div class="cat_desc col-xs-12 {if $category->id_image}col-sm-10{else}cat_desc_no_img col-sm-12{/if}">
